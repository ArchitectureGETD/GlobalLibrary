...
namespace iTextSharp.GE.text.pdf {
     ...
     * @see     PdfString
     * @see     PdfFont
     * @see     iTextSharp.GE.text.Chunk
     * @see     iTextSharp.GE.text.Font
     */
    ...
    public class PdfChunk {
        ...
        internal PdfChunk(Chunk chunk, PdfAction action) {
            ...
            Font f = chunk.Font;
            float size = f.Size;
            if (size == iTextSharp.GE.text.Font.UNDEFINED)
                size = 12;
            baseFont = f.BaseFont;
            //BaseFont bf = f.BaseFont;
            int style = f.Style;
            if (style == iTextSharp.GE.text.Font.UNDEFINED) {
                style = iTextSharp.GE.text.Font.NORMAL;
            }
            if (baseFont == null) {
